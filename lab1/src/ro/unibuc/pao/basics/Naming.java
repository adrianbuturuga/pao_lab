...
/** This class outlines proper naming of fields, methods and constants.
 *
...
public class Naming {
     ...
     */
    private int myVariableIsNice;

    /**
     * Constant values are usually named using uppercase letters. If the field name is comprised of multiple words,
